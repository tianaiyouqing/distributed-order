 ...
 * <pre/>
 */
package cloud.tianai.order.common.util.encryption;
...
public class CryptoUtils {
    ...
    public static String decrypt(String publicKeyText, String cipherText) throws Exception {
        PrivateKey privateKey = getPrivateKey(publicKeyText);
    ...
    public static PrivateKey getPrivateKey(String publicKeyText) {
        if (publicKeyText == null || publicKeyText.length() == 0) {
            publicKeyText = DEFAULT_PRIVATE_KEY_STRING;
        }

        try {
            byte[] privateKeyBytes = Base64.base64ToByteArray(publicKeyText);
    ...
    public static void main(String[] args) throws Exception {
        String[] strings = genKeyPair(1024);
//        System.out.println(Arrays.toString(strings));
        ...
        String encrypt = encrypt(publicKey, "你好");
