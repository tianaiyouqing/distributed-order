...
public class CanalUtils {
    ...
    static {
        ...
        // 对OrderMasterDO/OrderDetailDO 进行反序列化操作
        gsonBuilder.registerTypeAdapter(OrderMasterDO.class, new LowerCaseWithDeserializer<OrderMasterDO>());
        gsonBuilder.registerTypeAdapter(OrderDetailDO.class, new LowerCaseWithDeserializer<OrderDetailDO>());
        gsonBuilder.registerTypeAdapter(BusinessOrderMasterDO.class, new LowerCaseWithDeserializer<BusinessOrderMasterDO>());
        gsonBuilder.registerTypeAdapter(BusinessOrderDetailDO.class, new LowerCaseWithDeserializer<BusinessOrderDetailDO>());
    ...
    private static class LowerCaseWithDeserializer<T> implements JsonDeserializer<T> {
        ...
        public T deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
            ...
            T t = LOWER_CASE_WITH_UNDERSCORES_GSON.fromJson(jsonAsString, new TypeToken<T>(){}.getType());
            return t;
        }
    }

    public static <T> CanalResultData<T> converterForJson(String json) {
        CanalResultData<T> canalResultData = GSON.fromJson(json, new TypeToken<CanalResultData<T>>(){}.getType());
