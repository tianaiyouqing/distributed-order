...
@ConditionalOnProperty(prefix = "order.sync.mq", name = "type", havingValue = "ons", matchIfMissing = false)
public class OnsMqBusinessOrderSyncListener extends AbstractBusinessOrderSyncListener implements MessageListener {
