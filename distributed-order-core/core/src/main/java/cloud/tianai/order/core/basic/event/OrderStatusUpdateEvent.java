...
public class OrderStatusUpdateEvent extends ApplicationEvent {
     ...
     */
    public OrderStatusUpdateEvent(AbstractOrderStatusService.OrderStatusUpdate source) {
        super(source);
    }

    @Override
    public AbstractOrderStatusService.OrderStatusUpdate getSource() {
        return (AbstractOrderStatusService.OrderStatusUpdate) super.getSource();
    }
}
