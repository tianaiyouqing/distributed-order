package cloud.tianai.order.business.core.configuration.shardingjdbc.business;

import cloud.tianai.order.business.core.configuration.shardingjdbc.AbstractOrderShardingAlgorithm;
